      ...
      <div className="min-h-screen bg-white pt-14">
        <div className="max-w-4xl mx-auto px-4 py-12 md:py-20">
          ...
          <div className="prose prose-stone max-w-none">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mt-12 mb-4">Information Collection</h2>
            <p className="text-stone-700 leading-relaxed mb-4">YourCoachAgent collects the following types of information:</p>
            <ul className="list-disc pl-6 space-y-2 mb-6 text-stone-700">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mt-12 mb-4">How We Use Data</h2>
            <p className="text-stone-700 leading-relaxed mb-4">We use the collected information for the following purposes:</p>
            <ul className="list-disc pl-6 space-y-2 mb-6 text-stone-700">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mt-12 mb-4">Data Sharing</h2>
            <p className="text-stone-700 leading-relaxed mb-4">YourCoachAgent shares your information only under the following circumstances:</p>
            <ul className="list-disc pl-6 space-y-2 mb-6 text-stone-700">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mt-12 mb-4">Security Measures</h2>
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mt-12 mb-4">User Rights</h2>
            <p className="text-stone-700 leading-relaxed mb-4">You have the following rights regarding your personal data:</p>
            <ul className="list-disc pl-6 space-y-2 mb-6 text-stone-700">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mt-12 mb-4">GDPR Compliance</h2>
            <p className="text-stone-700 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mt-12 mb-4">California Privacy Rights</h2>
            <p className="text-stone-700 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mt-12 mb-4">Cookies</h2>
            <p className="text-stone-700 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-stone-900 mt-12 mb-4">Data Retention</h2>
            <p className="text-stone-700 leading-relaxed mb-6">
            ...
            <div className="mt-12 p-8 bg-stone-900 text-white rounded-2xl">
              <h3 className="text-xl font-semibold mb-3">Contact Us</h3>
              <p className="leading-relaxed">
                If you have questions or concerns about this Privacy Policy, please contact us at{' '}
                <a href="mailto:privacy@yourcoachagent.com" className="underline hover:text-stone-200">
